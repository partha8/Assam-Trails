const dataBase = {
  ...
  Festivals: [
    {
      ...
      desc: "The elephant festival of Assam is also known as the Kaziranga Elephant Festival since it is organized in the Kaziranga National Park situated in the state. The main aim of the festival is the conservation and the protection of Asiatic elephants, since poaching has drastically reduced their numbers, combined with other reasons, such as frequent accidents. The Forest Department of Assam and the Tourist Department jointly organize this festival. Through the festival, efforts are made, to decrease the man and animal conflict in regular life. Domesticated elephants are decked up for participation in this event. They also take part in a number of event like football, dance, and parade for the joy of the onlookers.",
      img: "https://www.tourmyindia.com/states/assam/images/elephant-festival-1.jpg",
      location: "Kaziranga National Park",
      rating: "4.5/5",
    },
    {
      name: "Brahmaputra Beach Fair and Festival",
      desc: "On the beaches of the mighty Brahmaputra River in Assam, an open air beach fair and festival is organized by the Assam Boat Racing and Rowing Association with support from the Assam Tourism Development Corporation. The festival coincides with the Magh Bihu, the harvesting festival celebrated in the state during the month of January. The Brahmaputra Beach Fair and Festival aims to promote the indigenous tradition and culture of the land to the youth of the state as well as the culture aficionados.",
      img: "https://www.tourmyindia.com/states/assam/images/brahmaputra-beach-1.jpg",
      location: "Brahmaputra Beach",
      rating: "4.6/5",
    },
    {
      name: "Ambubachi Mela",
      desc: "Ambubachi Mela is a fair held in the Kamakhya Temple in Guwahati. This is a Hindu religious festival and is that time of the season when Mother Nature or the mother goddess residing in the temple of Kamakhya menstruates. The Kamakhya Temple is one of the 52 Shaktipeethas and it is believed that the genitals of Shakti had fallen at this place. Thus, every year during the time of Ambubachi, or menstruation of the goddess, a large number of devotees gather here to perform religious rituals. The fair is held for 4 days in the month of June near the Kamakhya Temple.",
      img: "https://www.tourmyindia.com/states/assam/images/ambubachi-mela-1.jpg",
      location: "Kamakhya Temple",
      rating: "4.4/5",
    },
    {
      name: "Tea Fair and Festival",
      desc: "To celebrate the abundance of tea in the state, a tea fair and festival is organized during the month of November in the Jorhat district of Assam. During the festival, the Assam Tourism Department organizes tours to the nearby regions like Majuli Islands. The tea festival also offers combined holiday trips to the tourists to the nearby tea gardens, river cruises and even a game of golf. Here conferences are also held which deal with important issues regarding the tea industry. ",
      img: "https://www.tourmyindia.com/states/assam/images/tea-fair-festival-1.jpg",
      location: "Jorhat ",
      rating: "4.7/5",
    },
  ],
  Heritage: [
    {
      name: "Rock Cut Caves",
      desc: "The spellbinding specimens of the architecture are visible as the remains of the five rock-cut caves at Jogighopa on the bank of the Brahmaputra River in the district of Bongaigaon. Although, most of the studies say that the caves were established during the Salasthamba period but each of the caves has a brick and mud masonry made platform, which is in all probability was built during a later period. The art and architecture of the caves are great examples of the kind of art which were practiced during this time mainly in the western part of India. This translates to the fact that though far away, Assam was not cut off from the artistic movement in other parts of the country.",
      img: "https://www.tourmyindia.com/states/assam/images/rock-cut-caves-1.jpg",
      location: "Bongaigaon",
      rating: "4.3/5",
    },
    {
      name: "Kachari Fort",
      desc: "The Cachar district in Assam has a very important historical connection as it used to be the capital of the Cachar Kings during the medieval times. One such famous historical fort here is the Kachari Fort which is considered to be one of the magnificent forts to be visited in this area and tourists come here to see the remains of this kingdom at Khaspur which makes the place more interesting. It reflects the rich cultural heritage of the ancient era through the fine quality of work done by the engineers of those times. The fort is covered on all sides by the lush greenery which makes the place picturesque. The beautiful carvings on the walls of the fort depict the life style that the people of Assam had in those times. This fort used to be the pride of the Kachari kingdom and the existence of this site even today enhances the glory of Assam.",
      img: "https://www.tourmyindia.com/states/assam/images/kachar-fort-1.jpg",
      location: "Cachar",
      rating: "4.2/5",
    },
    {
      name: "Martyrs' Tomb",
      desc: "Built in 1964 - Martyr's Tomb was built in the memory of eleven Assam's language movement victims. The protest was held by the people who were against the local government decision to make Assamese as an official language keeping the fact in mind that the maximum number of residents are Bengali. This incident sparked a lot of protest due to which approximately 11 people died. One of the best attractions of Silchar, the tomb has a stunning architecture built by the finest engineers.",
      img: "http://photos.wikimapia.org/p/00/03/80/54/73_big.jpg",
      location: "Silchar",
      rating: "4.3/5",
    },
  ],
